  ...
  questions: [
    {
      ...
      followUps: [
        ...
        },
        {
          ...
          options: [
            "The OR HVAC system was found to have intermittent loss of positive pressure during door openings due to a faulty damper, allowing corridor air infiltration during sterile field setup",
      ...
      followUps: [
        ...
        },
        {
          ...
          options: [
            ...
            "Open gloving may only be used when changing a contaminated glove during a procedure (re-gloving) when the cuff of the gown is still intact and covered",
        ...
        },
        {
          ...
          options: [
            ...
            "The circulator's technique was correct; the deficiency is that the surgeon should have had another scrubbed team member tie the front waist tie using the sterile technique to establish the wrap-around sterile back panel",
      ...
      followUps: [
        ...
        },
        {
          ...
          options: [
            ...
            "The facility must conduct a root cause analysis to determine why the instrument is repeatedly unavailable through standard processing and acquire additional inventory to eliminate routine IUSS reliance",
        ...
        },
        {
          ...
          options: [
            ...
            "IUSS of implants is strongly discouraged and should only occur in a documented life-or-limb-threatening emergency; a full gravity cycle must be used, biological indicator must be run, and the surgeon must document acceptance of risk with informed consent from the patient",
      ...
      followUps: [
        ...
        },
        {
          ...
          options: [
            ...
            "The wet area must be covered immediately with an additional impervious sterile drape because moisture creates a pathway for bacterial migration (strike-through contamination) regardless of proximity to the incision",
        ...
        },
        {
          ...
          options: [
            "The extremity should be prepped, held elevated by a non-scrubbed team member wearing sterile gloves, and draped with an impervious stockinette followed by split sheets creating a circumferential sterile field around the limb",
      ...
      followUps: [
        ...
        },
        {
          ...
          options: [
            ...
            "Manufacturer name, lot/serial number, implant description, patient identifier, date of implantation, surgeon name, and sterilization verification (including BI results and load number)",
        ...
        },
        {
          ...
          options: [
            ...
            "The facility must initiate its recall/notification protocol: notify the infection preventionist, risk management, and the implanting surgeons; conduct a risk assessment; notify affected patients; monitor for signs of infection; and file an incident report with corrective action documentation",
      ...
      followUps: [
        ...
        },
        {
          ...
          options: [
            ...
            "The OR has negative pressure relative to the corridor, which is a critical deficiency — the tissue should flutter outward from the OR into the corridor",
        ...
        },
        {
          ...
          options: [
            ...
            "We perform daily pressure differential monitoring with a log documenting positive pressure verification, temperature (68-75°F), and humidity (20-60%) for each OR suite, with immediate engineering notification and OR hold protocols when parameters are out of range",
      ...
      followUps: [
        ...
        },
        {
          ...
          options: [
            ...
            "The mask must fully cover both the nose and mouth and be secured to prevent venting at the sides; a mask worn below the nose provides no barrier protection and violates AORN and Joint Commission standards",
        ...
        },
        {
          ...
          options: [
            ...
            "Surgical attire worn outside the perioperative suite should be covered with a single-use cover gown or lab coat, and the head covering should be changed upon return to the semi-restricted area to prevent introduction of external contaminants",
      ...
      followUps: [
        ...
        },
        {
          ...
          options: [
            ...
            "The circulator should advocate for the patient by requesting a re-exploration or additional imaging, document the unreconciled count and the surgeon's decision in the medical record, and file an incident report per facility policy",
        ...
        },
        {
          ...
          options: [
            ...
            "Standardizing count procedures with a structured counting protocol, implementing adjunct technology (RF detection or barcode sponge counting systems), conducting human factors analysis of the discrepancy events, and establishing a no-interruption zone during counting periods",
      ...
      followUps: [
        ...
        },
        {
          ...
          options: [
            ...
            "Use the facility's established escalation pathway — such as the CUS method (Concerned, Uncomfortable, Safety issue) or a structured communication tool — and if the surgeon still refuses, notify the charge nurse or OR supervisor to intervene",
        ...
        },
        {
          ...
          options: [
            ...
            "Redesign the OR layout and workflow to increase clearance between sterile field boundaries and non-sterile fixed equipment, install sterile light handle covers, and implement pre-incision sterile field boundary verification as part of the surgical safety checklist",
      ...
      followUps: [
        ...
        },
        {
          ...
          options: [
            ...
            "Reject the entire tray — a failed or equivocal internal chemical indicator means sterilization cannot be confirmed for the tray contents, even if the external indicator passed; notify SPD and obtain a replacement tray",
        ...
        },
        {
          ...
          options: [
            ...
            "Our program uses Class 1 external indicators on every package (process exposure), Class 5 integrators inside every package (parameter verification), biological indicators in every load (sterilization efficacy), plus Bowie-Dick tests daily for prevacuum sterilizers (air removal verification), with defined corrective actions for any indicator failure at each level",
      ...
      followUps: [
        ...
        },
        {
          ...
          options: [
            ...
            "Standing sterile solutions become contaminated over time through exposure to airborne microorganisms; AORN recommends solutions be discarded and replenished at regular intervals, and basins used for instrument rinsing should be refreshed frequently, especially during prolonged procedures",
        ...
        },
        {
          ...
          options: [
            ...
            "All medications and solutions on the sterile field must be labeled with the drug name, concentration, and expiration/preparation time; the verification process must include read-back between the circulator and scrub person; and any unlabeled solution must be immediately discarded",
      ...
      followUps: [
        ...
        },
        {
          ...
          options: [
            ...
            "A complete surgical count of all countable items must be performed jointly by the outgoing scrub person, incoming scrub person, and circulating nurse, with the count documented and any discrepancies reconciled before the outgoing scrub person leaves",
        ...
        },
        {
          ...
          options: [
            ...
            "Tray composition should be determined through a multidisciplinary review including surgeons, scrub techs, and SPD, using utilization data to eliminate rarely-used instruments, with standardized procedure-specific trays that reduce count complexity, processing time, and instrument damage while maintaining patient safety",
      ...
      followUps: [
        ...
        },
        {
          ...
          options: [
            ...
            "The facility should have implemented an interim life safety measure (ILSM) including risk assessment, increased environmental monitoring, notification to infection prevention, and consideration of suspending elective cases in the affected room until the HVAC is repaired",
        ...
        },
        {
          ...
          options: [
            ...
            "The facility's policy should include a defined process for temperature adjustments outside the standard range for specific patient populations (neonates, burn patients, elderly), requiring documentation of the clinical indication, surgeon order, and return to standard range after the case concludes",
      ...
      followUps: [
        ...
        },
        {
          ...
          options: [
            ...
            "The scrub tech should change gloves (re-glove) at minimum before handling sterile instruments again, as the outer glove surfaces may have been contaminated by contact with the unsterile gown below waist level or environmental surfaces during the period away from the field",
        ...
        },
        {
          ...
          options: [
            ...
            "The sterile back table was left unmonitored during the breaks, violating the principle of continuous surveillance of the sterile field; a relief scrub person should have been called to maintain the sterile field before the original scrub tech left",
      ...
      followUps: [
        ...
        },
        {
          ...
          options: [
            ...
            "Explain that while cover jackets with long sleeves are recommended in the semi-restricted area to contain skin squames, the direct link between cover jackets and SSI reduction is not definitively established in the literature; the practice is based on the theoretical benefit of reducing particulate shedding",
        ...
        },
        {
          ...
          options: [
            ...
            "We perform annual observational audits of surgical attire compliance (head covering, mask fit, attire worn outside OR), track compliance rates as a quality metric, correlate findings with SSI surveillance data, and use the results to drive targeted education and policy revisions through the perioperative quality committee",
      ...
      followUps: [
        ...
        },
        {
          ...
          options: [
            ...
            "The surgeon must document the clinical rationale for omitting the count in the operative note, an intraoperative X-ray should be obtained when the patient is stable, and an incident report must be filed documenting the omitted count per facility policy",
        ...
        },
        {
          ...
          options: [
            ...
            "The event should be reported through the facility's voluntary event reporting system, analyzed using a near-miss methodology to identify contributing factors (distractions, staffing, technique), shared as a de-identified learning opportunity with the perioperative team, and used to implement process improvements without punitive action against the individuals involved",
      ...
      followUps: [
        ...
        },
        {
          ...
          options: [
            ...
            "Sterile items must be stored at least 8-10 inches from the floor, 2 inches from walls, and 18 inches from ceiling sprinkler heads per AAMI standards; overstacking that causes compression compromises package integrity and violates event-related sterility principles",
        ...
        },
        {
          ...
          options: [
            ...
            "Assigning arbitrary time-based expiration dates contradicts the event-related sterility principle endorsed by AAMI and Joint Commission; sterile items with intact packaging remain sterile until an event compromises the barrier, and the facility's policy should be event-related rather than time-related",
      ...
      followUps: [
        ...
        },
        {
          ...
          options: [
            ...
            "The green stain indicates fluid has penetrated the outer glove through a micro-perforation not visible to the naked eye; the outer glove must be changed immediately using sterile technique, as the inner glove barrier has been breached by patient fluids",
        ...
        },
        {
          ...
          options: [
            ...
            "Immediately step back from the field, remove the gloves, wash the injury site with soap and water, report to the circulating nurse, change gown and gloves, and post-procedure: complete an incident report, undergo baseline bloodborne pathogen testing (HIV, Hepatitis B and C) within 1-2 hours, initiate post-exposure prophylaxis evaluation, identify the source patient for testing, and receive follow-up testing per OSHA schedule",
      ...
      followUps: [
        ...
        },
        {
          ...
          options: [
            ...
            "Cleaning solutions become contaminated with organic material and microorganisms during use; mop heads should be changed between rooms, and cleaning solution should be freshly prepared for each room to prevent cross-contamination between OR suites",
        ...
        },
        {
          ...
          options: [
            ...
            "Terminal cleaning is more extensive than between-case cleaning and includes: cleaning all horizontal and vertical surfaces (walls to a specified height), moving all portable equipment out to clean underneath and behind, cleaning the ceiling-mounted equipment tracks and light fixtures, wet-vacuuming or mopping the entire floor (not just the immediate procedural area), and cleaning the substerile area and scrub sinks",
      ...
      followUps: [
        ...
        },
        {
          ...
          options: [
            ...
            "Per OSHA Bloodborne Pathogen Standard, sharps containers must be replaced when they reach the manufacturer's indicated fill line (typically 2/3 to 3/4 full); overfilled containers increase the risk of needlestick injuries during disposal and container handling, and constitute an OSHA violation",
        ...
        },
        {
          ...
          options: [
            ...
            "A sharps injury log with detailed information (device type, department, procedure, injury description) for all percutaneous injuries, documentation of an annual review of safer sharps devices with frontline worker input, evidence that safety-engineered devices are used unless clinically contraindicated with documented justification, and an updated Exposure Control Plan reviewed annually",
