...
export const ddTransportLevel: DeepDiveLevel = {
  ...
  questions: [
      ...
      followUps: [
        {
          ...
          "No — bioburden begins drying within minutes",
    ...
    },
    {
      ...
      baseOptions: [
        "Yes — face protection is only needed when using power equipment",
        "Yes — gloves and gown are sufficient for manual cleaning",
        "No — face protection (mask + eye protection or face shield) is required",
        "No — she also needs shoe covers but face protection is optional"
      ],
      baseCorrectIndex: 2,
    ...
    },
    {
      ...
      baseOptions: [
        "No — sharps must be segregated in a puncture-resistant container",
        "Yes — as long as the sharps are placed on top for easy visibility",
        "No — sharps should be discarded in the OR sharps container only",
    ...
    },
    {
      ...
      baseOptions: [
        "Yes — but only if the wire brush diameter matches the lumen size",
        "Yes — wire brushes are effective for all types of lumen cleaning",
        "No — lumens should only be flushed, never brushed with any tool",
        "No — flexible endoscopic lumens require manufacturer-specified brushes"
      ],
      baseCorrectIndex: 3,
    ...
    },
    {
      ...
      baseOptions: [
        "Yes — as long as the sink is disinfected between instrument and hand use",
        "No — but only if the decontamination sink lacks a hands-free faucet",
        "No — instrument decontamination sinks and hand washing sinks must be separate",
        "Yes — a sink is a sink regardless of its designated use"
      ],
      baseCorrectIndex: 2,
      ...
      followUps: [
        {
          ...
          "No — the hand washing sink must be positioned to avoid splash contamination",
    ...
    },
    {
      ...
      baseOptions: [
        "No — manual cleaning requires cold water to prevent protein fixation",
        "No — water temperature for manual instrument cleaning should follow IFU",
        "Yes — lukewarm water is acceptable for all manual cleaning tasks",
        "Yes — any temperature between 90°F and 140°F is universally acceptable"
      ],
      baseCorrectIndex: 1,
      ...
      followUps: [
        {
          ...
          "No — hot water above 140°F coagulates blood proteins",
    ...
    },
    {
      ...
      baseOptions: [
        "No — the drop site must be inspected and cleaned per protocol",
        "Yes — as long as the container is wiped down before entering SPD",
        "Yes — the lid is secure and there was no visible spill",
        "No — the container must be returned to the OR for repackaging"
      ],
      baseCorrectIndex: 0,
    ...
    },
    {
      ...
      baseOptions: [
        "Yes — decontamination should have negative pressure relative to clean areas",
        "Yes — but only when the automated washers are actively running cycles",
        "No — decontamination should have positive pressure to push air out",
        "No — both areas should have equal air pressure balance"
      ],
      baseCorrectIndex: 0,
    ...
    },
    {
      ...
      baseOptions: [
        "No — but only because extra detergent wastes product and increases cost",
        "No — enzymatic detergent must be used at the manufacturer's concentration",
        "Yes — double concentration is acceptable for heavily soiled instruments",
        "Yes — more detergent always means better cleaning performance"
      ],
      baseCorrectIndex: 1,
    ...
    },
    {
      ...
      baseOptions: [
        "Yes — but only if the aluminum foil test shows uniform erosion pattern",
        "Yes — daily cavitation testing is the only required quality check",
        "No — cavitation testing is unnecessary if the unit is under warranty",
        "No — ultrasonic cleaners also require periodic efficacy verification testing"
      ],
      baseCorrectIndex: 3,
      ...
      followUps: [
        {
          ...
          options: [
          "No — uneven cavitation means the transducers may be",
    ...
    },
    {
      ...
      baseOptions: [
        "No — but she may remove the face shield if she steps back five feet",
        "Yes — she's not actively cleaning, just answering the phone briefly",
        "No — full PPE must be worn at all times in the decontamination area",
        "Yes — PPE requirements only apply during active instrument handling"
      ],
      baseCorrectIndex: 2,
    ...
    },
    {
      ...
      baseOptions: [
        "Yes — as long as separate sinks are used for each device type",
        "It depends — the facility must demonstrate proper workflow separation",
        "Yes — all contaminated devices can be processed together without restriction",
        "No — endoscopes and surgical instruments must always be in separate rooms"
      ],
      baseCorrectIndex: 1,
      ...
      followUps: [
        {
          ...
          "No — endoscope reprocessing may require specific water quality",
    ...
    },
    {
      ...
      baseOptions: [
        "No — soiled and clean items must use separate, dedicated transport equipment",
        "No — but only because the clean cart lacks a biohazard label on it",
        "Yes — as long as the clean cart is wiped down with disinfectant after use",
        "Yes — the container is sealed so the cart will not be contaminated"
      ],
      baseCorrectIndex: 0,
