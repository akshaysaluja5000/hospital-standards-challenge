  ...
  questions: [
    {
      ...
      },
      {
        ...
        options: [
          ...
          "Implement a supply par-level reduction plan, install visual clearance markers on walls at the 18-inch threshold, assign weekly compliance audits to the charge nurse, and escalate persistent violations to the unit director",
      ...
      },
      {
        ...
        options: [
          ...
          "Deficiencies in both EC.02.03.05 for inadequate corrective action effectiveness and HR.01.05.03 for failure to ensure staff knowledge of life safety requirements relevant to their work environment",
    ...
    },
    {
      ...
      },
      {
        ...
        options: [
          ...
          "Continue monitoring for at least two more quarters to confirm sustained improvement, establish a maintenance schedule for floor marking visibility, and integrate electrical panel clearance into new employee orientation for all departments",
    ...
    },
    {
      ...
      },
      {
        ...
        options: [
          ...
          "Implement a comprehensive exit sign preventive maintenance program with scheduled battery testing, establish a replacement cycle based on manufacturer specifications, and add exit sign battery function to monthly life safety inspection checklists",
      ...
      },
      {
        ...
        options: [
          ...
          "Findings under EC.02.03.05 for the obscured sign and EC.04.01.01 for lack of an effective process to maintain continuous egress visibility, with a potential finding under HR.01.05.03 for staff knowledge gaps regarding their role in life safety",
    ...
    },
    {
      ...
      },
      {
        ...
        options: [
          ...
          "The outdated backup binder violates OSHA's requirement that all SDS be the most current version available from the manufacturer, potentially providing incorrect hazard information, first aid procedures, or PPE requirements during an emergency",
      ...
      },
      {
        ...
        options: [
          ...
          "A finding under EC.02.02.01 and HR.01.05.03 indicating that while training was completed, it was not effective in ensuring staff competency in identifying workplace chemical hazards and appropriate protective measures",
    ...
    },
    {
      ...
      },
      {
        ...
        options: [
          ...
          "Design a functional exercise specifically targeting patient tracking and communication systems under surge conditions, with measurable objectives tied to the identified gaps, and include an after-action evaluation",
      ...
      },
      {
        ...
        options: [
          ...
          "Findings under EM.03.01.03 for failing to include at least one functional or community-based exercise, EM.01.01.01 for an outdated HVA, and EM.03.01.03 for after-action reports that do not demonstrate the improvement cycle through documented EOP modifications",
    ...
    },
    {
      ...
      },
      {
        ...
        options: [
          ...
          "Conduct targeted re-education on RACE procedures for the affected units, perform competency demonstrations with each staff member, implement a fire safety champion program on each unit, and re-drill within 30 days to verify improvement",
      ...
      },
      {
        ...
        options: [
          ...
          "Findings under EC.02.03.05 for drill program deficiency in not evaluating evacuation competency, and HR.01.05.03 for staff inability to demonstrate knowledge of smoke compartment boundaries and horizontal evacuation routes critical to defend-in-place strategy in healthcare occupancies",
    ...
    },
    {
      ...
      },
      {
        ...
        options: [
          ...
          "Implement immediate point-of-use filters on affected outlets in the transplant unit, initiate hyperchlorination or thermal eradication of the system, notify infection prevention and the clinical team, restrict water use for immunocompromised patients, and conduct follow-up cultures to verify remediation",
      ...
      },
      {
        ...
        options: [
          ...
          "EC.02.05.01 for failure to update the utility management plan and risk inventory when new clinical services were added, and EC.04.01.01 for failure to analyze utility incidents and near-misses to identify improvement opportunities",
    ...
    },
    {
      ...
      },
      {
        ...
        options: [
          ...
          "Halt construction immediately, inspect all barriers for breaches, perform additional air sampling to define the extent of contamination, implement supplemental HEPA filtration in the oncology unit, notify the infectious disease team, and assess all immunocompromised patients for potential Aspergillus exposure",
      ...
      },
      {
        ...
        options: [
          ...
          "Findings under IC.02.02.01 for inadequate ICRA monitoring and enforcement, EC.02.06.05 for failure to manage the construction environment, and LD.03.02.01 for insufficient leadership oversight of contractor compliance with hospital infection control requirements",
    ...
    },
    {
      ...
      },
      {
        ...
        options: [
          ...
          "Develop a prioritized corrective action plan based on risk severity, implement ILSMs for all deficient doors, assign specific completion dates for each repair, track progress through the EOC Committee, and conduct a root cause analysis to determine why the preventive maintenance program did not identify these issues",
      ...
      },
      {
        ...
        options: [
          ...
          "The organization corrected the individual deficiencies but failed to improve the ongoing fire door inspection and maintenance program, indicating a likely finding under EC.02.03.05 for inadequate preventive maintenance and EC.04.01.01 for failure to use findings to improve the management program",
    ...
    },
    {
      ...
      },
      {
        ...
        options: [
          ...
          "Immediately add all untracked infusion pumps to the equipment inventory, conduct initial safety inspections on each, implement a centralized equipment tracking system with automated PM scheduling and alerts, and establish a process requiring all new equipment acquisitions regardless of source to be registered before clinical use",
      ...
      },
      {
        ...
        options: [
          ...
          "EC.02.04.01 for inadequate medical equipment management program that does not include a process for monitoring and responding to FDA recalls, safety alerts, and hazard notifications for equipment in the inventory, representing a potential patient safety risk",
    ...
    },
    {
      ...
      },
      {
        ...
        options: [
          ...
          "Implement a targeted education campaign with visual aids posted at waste stations, conduct hands-on sorting demonstrations in high-violation departments, establish a waste segregation competency assessment for all clinical staff, and monitor compliance through periodic waste stream audits",
      ...
      },
      {
        ...
        options: [
          ...
          "EC.02.02.01 for multiple deficiencies in regulated medical waste storage including lack of security, absence of secondary containment and rigid containers, improper storage conditions, and no posted spill procedures; EC.02.06.01 for environmental safety hazards; and potential state regulatory violations for storage duration and containment requirements",
    ...
    },
    {
      ...
      },
      {
        ...
        options: [
          ...
          "Present the data showing that increased reporting is a positive indicator of improved reporting culture, while the reduction in physical assaults demonstrates program effectiveness; recommend continued focus on de-escalation training and analysis of verbal threat data to identify intervention opportunities before escalation occurs",
      ...
      },
      {
        ...
        options: [
          ...
          "PC.03.05.01 for restraint use without timely physician orders, HR.01.05.03 for staff inability to articulate least-restrictive intervention protocols and escalation procedures, and EC.02.01.01 for inadequate implementation of the security management plan in a high-risk area where staff competency in behavioral management is a critical security component",
    ...
    },
    {
      ...
      },
      {
        ...
        options: [
          ...
          "Relocate the outdoor air intake to a position that is at least 25 feet from any area where smoking occurs, modify the HVAC system to include enhanced filtration for the lobby zone, enforce the smoke-free campus policy more rigorously at the main entrance, and conduct follow-up air quality monitoring to verify the effectiveness of the interventions",
      ...
      },
      {
        ...
        options: [
          ...
          "EC.02.06.01 for insufficient monitoring of environmental conditions related to the smoke-free policy, EC.04.01.01 for lack of data to evaluate the effectiveness of the air quality and smoking management programs, and potential concern regarding staff understanding of their role in maintaining a safe environment",
    ...
    },
    {
      ...
      },
      {
        ...
        options: [
          ...
          "Implement a mandatory post-work inspection process requiring a facilities supervisor and infection prevention representative to jointly verify ceiling restoration, fire-stopping integrity, and barrier removal before any above-ceiling permit can be closed, with photographic documentation of the restored space",
      ...
      },
      {
        ...
        options: [
          ...
          "EC.02.03.05 for breached fire-stopping compromising smoke compartment integrity, EC.02.06.05 for a deficient above-ceiling permit program that closed permits without verifying restoration, and IC.02.02.01 for infection control risk from accumulated debris in the ceiling plenum above a patient care area",
    ...
    },
    {
      ...
      },
      {
        ...
        options: [
          ...
          "Immediately schedule professional maintenance for all overdue extinguishers, prioritizing those in critical patient care areas, replace any that fail inspection, document the corrective action plan, and implement a tracking system with automated alerts to prevent future lapses in the annual inspection schedule",
      ...
      },
      {
        ...
        options: [
          ...
          "EC.02.03.05 for blocked fire extinguisher access, EC.04.01.01 for an unreliable monthly inspection process that documented compliance while the extinguisher was inaccessible, and a concern under HR.01.05.03 regarding staff ability to recognize life safety hazards in their immediate environment",
    ...
    },
    {
      ...
      },
      {
        ...
        options: [
          ...
          "Repair the cooling system, retest to verify 4-hour capability, conduct a comprehensive assessment of the generator's remaining useful life, evaluate whether the current generator capacity meets the facility's emergency power needs given any recent expansions, and present findings to leadership for capital planning including potential generator replacement or supplemental capacity",
      ...
      },
      {
        ...
        options: [
          ...
          "EC.02.05.01 for failure to maintain a current utility system inventory that identifies all critical equipment connected to emergency power, EC.02.05.07 for inability to demonstrate that the emergency power system's capacity is adequate for its current load, and a concern under LD.03.02.01 for lack of a process to evaluate emergency power implications when new clinical equipment is added",
    ...
    },
    {
      ...
      },
      {
        ...
        options: [
          ...
          "Conduct a cumulative ILSM assessment evaluating the combined impact of both impairments, increase fire watch coverage to address both zones, evaluate whether patient relocation from the area between the two impaired zones is necessary, update the fire department notification to reflect the expanded impairment area, and ensure leadership reviews and approves the expanded risk acceptance",
      ...
      },
      {
        ...
        options: [
          ...
          "EC.02.03.05 for failure to reassess ILSMs when conditions changed, increasing the risk beyond what the original assessment addressed; and LD.03.02.01 for inadequate leadership and EOC Committee oversight of an extended fire protection impairment, as the Committee is expected to monitor ongoing ILSMs and ensure they remain appropriate throughout the impairment period",
    ...
    },
    {
      ...
      },
      {
        ...
        options: [
          ...
          "Conduct a facility-wide hazardous materials storage assessment using SDS compatibility guidelines, implement physical segregation with secondary containment where required, develop department-specific chemical storage maps, train staff on chemical compatibility principles, and establish a periodic storage compliance audit process",
      ...
      },
      {
        ...
        options: [
          ...
          "EC.02.02.01 for a hazardous materials management program that is not effectively protecting workers from chemotherapy drug exposure, HR.01.05.03 for failure to verify competency after training as demonstrated by the nurse's inability to correctly perform the spill cleanup procedure, and potential OSHA violations under 29 CFR 1910.1200 for inadequate hazard-specific training on cytotoxic drug handling",
    ...
    },
    {
      ...
      },
      {
        ...
        options: [
          ...
          "The annual evaluation must go beyond activity completion to include analysis of performance data such as drill response times and staff competency results, trend analysis of fire safety findings over multiple years, identification of improvement opportunities, and establishment of specific measurable objectives for the coming year that address identified gaps",
      ...
      },
      {
        ...
        options: [
          ...
          "EC.04.01.01 for failure to demonstrate integration across EC management plans where findings in one domain inform risk assessment and actions in related domains, and LD.04.04.01 for insufficient organizational performance improvement integration, as cross-functional events require coordinated analysis across safety, security, human resources, and performance improvement programs",
    ...
    },
    {
      ...
      },
      {
        ...
        options: [
          ...
          "Implement an immediate facility-wide corridor clearance initiative that brings all egress corridors into compliance, followed by a systematic assessment of storage needs by department, development of equipment staging areas that do not impinge on egress corridors, revision of department workflows that contribute to corridor storage, and establishment of ongoing monitoring with accountability",
      ...
      },
      {
        ...
        options: [
          ...
          "EC.02.03.05 for blocked access to the fire extinguisher and electrical panel, EC.02.01.01 for a safety management approach that displaced rather than solved the storage problem creating new hazards, and HR.01.05.03 for staff education that addressed corridor clearance without teaching the broader principles of maintaining access to life safety equipment and electrical infrastructure",
