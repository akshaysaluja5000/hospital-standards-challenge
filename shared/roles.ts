...
export const ROLE_CONFIGS: RoleConfig[] = [
  ...
  // ==========================================================================
  // DNV ROLES (DNV Healthcare DIAS / dnv module)
  // ==========================================================================
  {
    id: "dnv_full_track",
    facilityType: "dnv",
    department: "DNV DIAS Standards",
    title: "All DNV DIAS Standards",
    description: "Complete DNV DIAS curriculum — all 11 standard domains for hospital accreditation readiness",
    scope: "FULL",
    destinationRoute: "/play/dnv_qm",
    firstModuleId: "dnv_qm",
    reportingScope: "enterprise",
    chapters: DNV_ALL_CHAPTERS,
  },
  {
    id: "dnv_qm_track",
    facilityType: "dnv",
    ...
    description: "Organization-wide QMS, ISO 9001 integration, performance indicators, RCA/CAPA, QAPI projects, governing body reporting",
    scope: "DEPT",
    destinationRoute: "/play/dnv_qm",
    firstModuleId: "dnv_qm",
    reportingScope: "own_department",
  ...
  },
  {
    ...
    description: "Governing body authority, mission approval, CEO appointment and evaluation, medical staff bylaws, conflict of interest",
    scope: "DEPT",
    destinationRoute: "/play/dnv_gb",
    firstModuleId: "dnv_gb",
    reportingScope: "own_department",
    chapters: ["dnv_gb"],
  },
  {
    ...
    description: "Credentialing with PSV, NPDB queries, specific privilege delineation, OPPE, FPPE, peer review",
    scope: "DEPT",
  ...
  },
  {
    ...
    description: "Nursing executive authority, acuity-based staffing, unit-specific competencies, float/agency staff, staffing plans and variance tracking",
    scope: "DEPT",
  ...
  },
  {
    ...
    description: "Patient rights, informed consent, advance directives, individualized care planning, patient education, discharge planning",
    scope: "DEPT",
  ...
  },
  {
    ...
    description: "Pharmacist oversight, high-alert medication safeguards, after-hours access controls, ADR reporting",
    scope: "DEPT",
  ...
  },
  {
    ...
    description: "OR organization and equipment, OR register (10 elements), pre/post-anesthesia evaluation, wrong-site prevention",
    scope: "DEPT",
    destinationRoute: "/play/dnv_ot",
    firstModuleId: "dnv_ot",
    reportingScope: "own_department",
    chapters: ["dnv_ot"],
  },
  {
    ...
    description: "IPC program organization, HAI prevention (SSI/CLABSI/CAUTI/VAP/MDRO), surveillance, IPC committee reporting",
    scope: "DEPT",
  ...
  },
  {
    ...
    description: "Complete, accurate, confidential records; entry requirements; verbal orders; retention; confidentiality and access controls",
    scope: "DEPT",
    destinationRoute: "/play/dnv_mr",
    firstModuleId: "dnv_mr",
    reportingScope: "own_department",
    chapters: ["dnv_mr"],
  },
  {
    ...
    description: "Physical environment inspections, utility system maintenance, life safety, emergency preparedness with HVA-based EOP",
    scope: "DEPT",
  ...
  },
  {
    ...
    description: "Laboratory, blood management, imaging, nuclear medicine, emergency, dietary, rehabilitation, restraint/seclusion",
    scope: "DEPT",
    destinationRoute: "/play/dnv_sp",
    firstModuleId: "dnv_sp",
    reportingScope: "own_department",
    chapters: ["dnv_sp"],
  },
];
