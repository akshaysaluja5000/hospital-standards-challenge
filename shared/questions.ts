...
const hospitalLevelsRaw: Level[] = [
  {
    ...
    studyMaterial: [
      ...
      {
        title: "Instrument Positioning for Transport",
      ...
      {
        title: "Container Lids Must Be Secured",
      ...
      {
        title: "Soiled Corridor: No Shortcuts",
      ...
      {
        title: "Soiled Utility Room: 4 Required Elements",
      ...
      {
        title: "Why Timing Matters After a Case",
      ...
      {
        title: "Common Mistake: Instruments Locked During Transport",
      ...
      {
        title: "Common Mistake: PPE Incomplete",
  ...
  },
  {
    ...
    studyMaterial: [
      ...
      {
        title: "Dust on Overhead Surfaces",
      ...
      {
        title: "EOC Rounds: What Gets Flagged",
      ...
      {
        title: "Tape Residue: A Common Miss",
      ...
      {
        title: "Easy-to-Miss Dust Locations",
      ...
      {
        title: "Common Mistake: Cosmetic vs. Compliance",
  ...
  },
  {
    ...
    studyMaterial: [
      {
        title: "The Clean/Dirty Separation Principle",
      ...
      {
        title: "Floor Storage: Minimum Clearance",
      ...
      {
        title: "Sink Designation Is Absolute",
      ...
      {
        title: "Distance From Sinks: The 3-Foot Rule",
      ...
      {
        title: "Food & Beverages in Clinical Areas",
      ...
      {
        title: "Clinical Refrigerators: Strict Separation",
      ...
      {
        title: "Clean vs. Soiled Utility Rooms",
      ...
      {
        title: "Scenario: Clean Cart Next to Soiled Hamper",
      ...
      {
        title: "Scenario: Staff Food in Break Room Fridge",
      ...
      {
        title: "Common Mistake: Mop in the Clean Utility Room",
  ...
  },
  {
    ...
    studyMaterial: [
      ...
      {
        title: "Events That Break Sterility",
      ...
      {
        title: "No Cardboard in Sterile Storage",
      ...
      {
        title: "Sterile Storage Shelving Requirements",
      ...
      {
        title: "Temperature & Humidity in Sterile Storage",
      ...
      {
        title: "Compromised Package: Act Immediately",
      ...
      {
        title: "Chemical vs. Biological Indicators",
      ...
      {
        title: "Common Mistake: Expired Items in Active Stock",
  ...
  },
  {
    ...
    studyMaterial: [
      {
        title: "Visual Inspection: What to Look For",
      ...
      {
        title: "Peel Pack Inspection: 6 Checks",
      ...
      {
        title: "Lighted Magnification: Required, Not Optional",
      ...
      {
        title: "Common Mistake: Visible Residue After Cleaning",
      ...
      {
        title: "Common Mistake: 'Just Cosmetic'",
  ...
  },
  {
    ...
    studyMaterial: [
      {
        title: "Blanket Warmer Temperature Limit",
      ...
      {
        title: "Fluid Warmer Requirements",
      ...
      {
        title: "Oxygen Cylinder Storage Rules",
      ...
      {
        title: "Emergency Call Cord Placement",
      ...
      {
        title: "Medication Refrigerator Monitoring",
      ...
      {
        title: "Glucometer Cleaning: Dwell Times Matter",
      ...
      {
        title: "Ultrasound Gel Expiration",
      ...
      {
        title: "Common Mistake: Fluids in Blanket Warmers",
  ...
  },
  {
    ...
    studyMaterial: [
      {
        title: "Decontamination Room Air Pressure",
      ...
      {
        title: "Full PPE in Decontamination",
      ...
      {
        title: "Enzymatic Detergent: IFU Compliance",
      ...
      {
        title: "Cleaning Brushes: Inspection & Frequency",
      ...
      {
        title: "Automated Washer Quality Testing",
      ...
      {
        title: "Final Rinse Water Quality",
      ...
      {
        title: "Biological Indicators (BIs)",
      ...
      {
        title: "Peel Pack Packaging Rules",
      ...
      {
        title: "Common Mistake: Sterilizer Logs Incomplete",
  ...
  },
  {
    ...
    studyMaterial: [
      ...
      {
        title: "Hair Coverage: ALL Hair, All the Time",
      ...
      {
        title: "Surgical Mask Compliance",
      ...
      {
        title: "Skin Prep Must Be Fully Dry",
      ...
      {
        title: "Medication Labeling on the Sterile Field",
      ...
      {
        title: "Anesthesia Surface Cleaning",
      ...
      {
        title: "Common Mistake: Non-Sterile Person Reaching Over Field",
  ...
  },
  {
    ...
    studyMaterial: [
      {
        title: "Time-Out: When It Happens",
      ...
      {
        title: "Time-Out: Required Elements",
      ...
      {
        title: "Two Unique Patient Identifiers",
      ...
      {
        title: "Informed Consent: Required Elements",
      ...
      {
        title: "Site Marking for Bilateral Procedures",
  ...
  },
  {
    ...
    studyMaterial: [
      {
        title: "Post-Anesthesia Evaluation: Timing & Elements",
      ...
      {
        title: "Post-Op Note: Required Elements",
      ...
      {
        title: "Pain Assessment Frequency & Reassessment",
      ...
      {
        title: "Opioid Administration: LOC Monitoring",
      ...
      {
        title: "Medication Reconciliation & Security",
      ...
      {
        title: "Fall Risk Assessment Requirements",
      ...
      {
        title: "Suicide Screening Protocol",
      ...
      {
        title: "Intake & Output and Restraints",
  ...
  },
  {
    ...
    studyMaterial: [
      {
        title: "Sharps Container Requirements",
      ...
      {
        title: "Eyewash Station Accessibility",
      ...
      {
        title: "EVS Closets & Chemical Labeling",
      ...
      {
        title: "Preventive Maintenance Stickers",
      ...
      {
        title: "Pill Cutters, Crushers & Glucometers",
      ...
      {
        title: "Open Supply Expiration Dates",
