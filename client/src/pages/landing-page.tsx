        ...
        <section className="max-w-5xl mx-auto px-4 py-20 md:py-32 text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl leading-relaxed font-normal" data-testid="text-hero-subtitle">
              Accreditation <em>Ready</em> turns Joint Commission, AAAHC, DNV Healthcare, and CMS standards into focused daily training — so your staff stays prepared year-round, not just before survey week.
            </p>
            ...
            <p className="text-sm text-muted-foreground mt-1" data-testid="text-hero-supporting">
              Built on real JC, AAAHC, DNV, and CMS standards · No in-service time required
            </p>
          </motion.div>
        </section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                >
                  <div className="rounded-2xl border border-border bg-card p-6 h-full flex flex-col gap-4">
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      When a new policy or procedure is uploaded, this agent reads it, auto-tags it to the relevant JC/AAAHC/DNV standards, generates quiz questions from it, and flags if the policy contradicts a standard.
                    </p>
                    <div className="mt-auto pt-2 border-t border-border">
                      <p className="text-xs text-muted-foreground leading-relaxed">
                ...
                >
                  <div className="rounded-2xl border border-border bg-card p-6 h-full flex flex-col gap-4">
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      Monitors Joint Commission, AAAHC, DNV Healthcare, and CMS public channels for standard updates, new chapters, and survey focus shifts. When the NPG chapter launched January 2026, this agent would have flagged it automatically and initiated a content build task — rather than discovering the gap months later.
                    </p>
                    <div className="mt-auto pt-2 border-t border-border">
                      <p className="text-xs text-muted-foreground leading-relaxed">
      ...
      <footer className="relative z-10 border-t border-border py-6 px-4 bg-muted/30">
        <div className="max-w-5xl mx-auto text-center">
          <p className="text-sm text-muted-foreground leading-relaxed" data-testid="text-disclaimer">
            Accreditation <em>Ready</em> is not affiliated with, endorsed by, or sponsored by The Joint Commission, AAAHC, DNV Healthcare, or CMS. All content is for training and educational purposes only.
          </p>
