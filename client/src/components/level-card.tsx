...
import { Lock, CheckCircle2, Star, Truck, Building2, ArrowLeftRight, Package, Wrench, Thermometer } from "lucide-react";
...
export function LevelCard({ level, progress, isUnlocked, index, onClick }: LevelCardProps) {
